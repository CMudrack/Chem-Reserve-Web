...
class ChemicalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chemical" do
    assert_difference('Chemical.count') do
      post chemicals_url, params: { chemical: { amount: @chemical.amount, name: @chemical.name } }
    end
  ...
  test "should update chemical" do
    patch chemical_url(@chemical), params: { chemical: { amount: @chemical.amount, name: @chemical.name } }
